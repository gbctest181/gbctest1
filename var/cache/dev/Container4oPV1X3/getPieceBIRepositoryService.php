...
// Returns the private 'App\Repository\PieceBIRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PieceBIRepository.php';

return $this->privates['App\\Repository\\PieceBIRepository'] = new \App\Repository\PieceBIRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
