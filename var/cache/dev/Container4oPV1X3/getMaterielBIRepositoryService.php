...
// Returns the private 'App\Repository\MaterielBIRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\MaterielBIRepository.php';

return $this->privates['App\\Repository\\MaterielBIRepository'] = new \App\Repository\MaterielBIRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
