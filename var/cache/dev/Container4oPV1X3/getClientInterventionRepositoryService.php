...
// Returns the private 'App\Repository\ClientInterventionRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ClientInterventionRepository.php';

return $this->privates['App\\Repository\\ClientInterventionRepository'] = new \App\Repository\ClientInterventionRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
