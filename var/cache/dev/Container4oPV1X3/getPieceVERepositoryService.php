...
// Returns the private 'App\Repository\PieceVERepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\PieceVERepository.php';

return $this->privates['App\\Repository\\PieceVERepository'] = new \App\Repository\PieceVERepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
