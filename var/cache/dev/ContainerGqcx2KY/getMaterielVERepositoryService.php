...
// Returns the private 'App\Repository\MaterielVERepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\MaterielVERepository.php';

return $this->privates['App\\Repository\\MaterielVERepository'] = new \App\Repository\MaterielVERepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
