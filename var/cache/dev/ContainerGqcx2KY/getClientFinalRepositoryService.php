...
// Returns the private 'App\Repository\ClientFinalRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ClientFinalRepository.php';

return $this->privates['App\\Repository\\ClientFinalRepository'] = new \App\Repository\ClientFinalRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
