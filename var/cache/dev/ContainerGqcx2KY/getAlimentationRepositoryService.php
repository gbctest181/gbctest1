...
// Returns the private 'App\Repository\AlimentationRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\AlimentationRepository.php';

return $this->privates['App\\Repository\\AlimentationRepository'] = new \App\Repository\AlimentationRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
